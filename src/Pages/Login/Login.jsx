            ...
            <div className="container flex flex-col justify-center p-6 mx-auto sm:py-12 lg:py-24 lg:flex-row lg:justify-between">
                ...
                <div className="w-full max-w-md p-4 rounded-md shadow sm:p-8  text-gray-900">
                    ...
                    <div className=" space-y-4">
                        <button aria-label="Login with Google" type="button" className="flex items-center justify-center w-full p-4 space-x-4 border rounded-md btn btn-outline hover:bg-[#2563EB]">
                    ...
                    <form className="space-y-8">
                        <div className="space-y-4">
                            <div className="space-y-2">
                                ...
                                <input type="email" name="email" id="email" placeholder="leroy@jenkins.com" className="w-full px-3 py-2 border rounded-md border-gray-700  text-gray-900 focus:border-violet-400" />
                            </div>
                            <div className="space-y-2">
                                ...
                                <input type="password" name="password" id="password" placeholder="*****" className="w-full px-3 py-2 border rounded-md border-gray-700  text-gray-900 focus:border-violet-400" />
                            </div>
                        </div>
